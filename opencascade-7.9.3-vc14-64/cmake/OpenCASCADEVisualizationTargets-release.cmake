...
set_target_properties(TKOpenGles PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/win64/vc14/lib/TKOpenGles.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/win64/vc14/bin/TKOpenGles.dll"
  )

list(APPEND _cmake_import_check_targets TKOpenGles )
list(APPEND _cmake_import_check_files_for_TKOpenGles "${_IMPORT_PREFIX}/win64/vc14/lib/TKOpenGles.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKOpenGles.dll" )
...
list(APPEND _cmake_import_check_files_for_TKIVtk "${_IMPORT_PREFIX}/win64/vc14/lib/TKIVtk.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKIVtk.dll" )
...
set_target_properties(TKD3DHost PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/win64/vc14/lib/TKD3DHost.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/win64/vc14/bin/TKD3DHost.dll"
  )

list(APPEND _cmake_import_check_targets TKD3DHost )
list(APPEND _cmake_import_check_files_for_TKD3DHost "${_IMPORT_PREFIX}/win64/vc14/lib/TKD3DHost.lib" "${_IMPORT_PREFIX}/win64/vc14/bin/TKD3DHost.dll" )
